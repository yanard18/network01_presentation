...
- **Embedded Diagrams**: Clean integration of SVG diagrams (`http_overview.svg`).
...
### 2. Add New Slides
1. Choose a template from `templates/` (e.g. `templates/01_standard_card_slide.html`).
2. Create a new file in `slides/` (e.g. `slides/12_my_new_topic.html`).
